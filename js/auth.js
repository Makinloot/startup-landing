...
signupForm.addEventListener('submit', (e) => {
    ...
    const validInputs = {
        ...
        confirm_password: validateInputs(inputFields.confirm_password, inputErrors.confirm_password),
...
function validateInputs(input, error) {
    if(!input.validity.valid) {
        ...
        else if(input.validity.patternMismatch) error.innerText = 'Password too weak';
